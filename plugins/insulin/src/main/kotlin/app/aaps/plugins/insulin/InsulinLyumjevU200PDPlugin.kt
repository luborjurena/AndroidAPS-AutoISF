...
/**
 * The IOB shown by AAPS is the delivered volume, so half of the actual number of units.
 * Basals must be halved and ISFs doubled in the profile before using this plugin.
 */
@Singleton
class InsulinLyumjevU200PDPlugin @Inject constructor(
    ...
    override val concentrationFactor = 2.0
